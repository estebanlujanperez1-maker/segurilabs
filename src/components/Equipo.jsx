export default function Equipo() {
  ...
  const AvatarPlaceholder = () => (
    <svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg" style={{ width: "65%", height: "65%", color: "#a0b8c8" }}>
      <circle cx="40" cy="30" r="16" fill="currentColor" opacity="0.4" />
      <ellipse cx="40" cy="70" rx="26" ry="17" fill="currentColor" opacity="0.25" />
    </svg>
  );
  ...
  return (
    <div style={{ fontFamily: "'Segoe UI', system-ui, sans-serif", maxWidth: "1100px", margin: "0 auto", padding: "60px 24px" }}>
      <p style={{ textAlign: "center", fontSize: "11px", fontWeight: 700, letterSpacing: "2.5px", color: "#3aaa7a", textTransform: "uppercase", marginBottom: "10px" }}>
        Nuestro equipo
      </p>
      <h2 style={{ textAlign: "center", fontSize: "32px", fontWeight: 800, color: "#1a3a5c", marginBottom: "48px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "40px" }}>
        {team.map((member, i) => (
          <div key={i} style={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
            {/* Avatar */}
            <div style={{ alignSelf: "center", marginBottom: "24px", width: "180px", height: "180px" }}>
              <div style={{
                width: "180px", height: "180px", borderRadius: "50%", padding: "5px",
                background: "linear-gradient(135deg, #1a5c45, #3aaa7a, #4cd694)",
                display: "flex", alignItems: "center", justifyContent: "center",
              }}>
                <div style={{
                  width: "100%", height: "100%", borderRadius: "50%",
                  background: "#e8f0f5", overflow: "hidden",
                  display: "flex", alignItems: "center", justifyContent: "center",
                }}>
                  <AvatarPlaceholder />
                </div>
            ...
            {/* Info */}
            <div style={{ fontSize: "22px", fontWeight: 800, color: "#1a1a1a", marginBottom: "4px" }}>{member.name}</div>
            <div style={{ fontSize: "13px", fontWeight: 700, color: "#3aaa7a", marginBottom: "12px" }}>{member.role}</div>
            <p style={{ fontSize: "13px", color: "#5a6a7a", lineHeight: "1.65", marginBottom: "20px", flex: 1 }}>{member.bio}</p>
            ...
            <div style={{
              ...
              <a href={member.facebook} target="_blank" rel="noreferrer" aria-label="Facebook"
                style={{ color: "#fff", display: "flex", alignItems: "center", textDecoration: "none", opacity: 0.9 }}>
                <IconFacebook />
              </a>
